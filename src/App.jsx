        ...
        <Box>
          {selectedId ? (
            ...
            <>
              ...
              <WatchedMovieList watched={watched} onDeletedMovie={handleDeleteWatched} />
            </>
          )}
        </Box>
      </Main>
...
function WatchedSummary({ watched }) {
  ...
  const avgWatchedRuntime = average(watched.map((movie) => movie.runtime));
  return (
    <div className="summary">
      ...
      <div>
        ...
        <p>
          <span>⏳</span>
          <span>{Number(avgWatchedRuntime.toFixed(0))} min</span>
        </p>
      </div>
    </div>
  );
...
function WatchedMovieList({ watched, onDeletedMovie }) {
  return (
    <ul className="list">
      {watched.map((movie) => (
        <WatchedMovie movie={movie} key={movie.imdbID} onDeletedMovie={onDeletedMovie} />
      ))}
    </ul>
  );
}
      ...
      {isLoading ? (
        ...
        <>
          <header>
            ...
            <img src={poster} style={{ width: "150px" }} alt={`Poster of ${movie}`} />
  ...
  return (
    <li>
      ...
      <div>
        ...
        <button onClick={() => onDeletedMovie(movie.imdbID)} className="btn-delete">
          X
        </button>
      </div>
    </li>
